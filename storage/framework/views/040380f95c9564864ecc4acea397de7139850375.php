                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    ...
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="/" class="m-brand__logo-wrapper">
                            <img alt="" src="<?php echo e(asset('img/2HEX-logo2.png')); ?>"/>
                        </a>
                    </div>
                            ...
                            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                ...
                                <a href="#" class="m-nav__link m-dropdown__toggle">
                                     ...
                                     <span class="m-topbar__userpic">
                                         <span class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder"><?php echo e(Auth::user()->name); ?></span>
                                     </span>
                                        ...
                                        <div class="m-dropdown__header m--align-center" style="background: url(img/back.jpg); background-size: cover;">
                                            <div class="m-card-user m-card-user--skin-dark">
                                                ...
                                                <div class="m-card-user__details">
                                                    <span class="m-card-user__name m--font-weight-500"><?php echo e(Auth::user()->name); ?></span>
                                                    <a href="/inquiries" class="m-card-user__email m--font-weight-300 m-link"><?php echo e(Auth::user()->email); ?></a>
                                                </div>
                                            </div>
                                        </div>
