...
@section('title', 'SKATEBOARD HEAT TRANSFER CONFIGURATOR')

@push('head.meta')
    <meta name="description" content="2HEX skateboard heat transfer manufacturer. A skateboard manufacturer of wheels, decks, skateboard wheels, heat transfers and high quality complete skateboards">
                            ...
                            <div class="m-form m-form--label-align-left- m-form--state-">
                                ...
                                <div class="m-portlet__foot m-portlet__foot--fit m--margin-top-40">
                                    <div id="preview" style="
                                        height: 300px;
                                        background-image: url(/img/heat-transfer/custom-skateboard-heat-transfer.jpg);
                ...
                <div class="col-xl-3">
                    <div class="m-portlet">
                        <div class="m-portlet__body">
                            <div class="m-section">
                                <h2 class="m-section__heading">Heat Transfer</h2>
                                <div class="m-section__content">
                                    <img alt="Grip Tape" title="Grip Tape" src="/img/heat-transfer/manufacturer-right-side.jpg" style="width: 100%" />
                                </div>
                            </div>
                            <!--end: Form Body -->
                        </div>
