    <thead style="background-color: #52a3f0; color: white;">
       ...
       @foreach($wheels1 as $batch => $wheel)
        ...
        <tr>
            ...
            <td class="align-middle text-center">{{$wheel->type}}</td>
            <td class="align-middle text-center">{{$wheel->shape}}</td>
            <td class="align-middle text-center">{{$wheel->size}}</td>
            <td>
                {{$wheel->hardness}}<br>
            ...
            <td class="align-middle text-center">{{$wheel->cardboard_print ?? 'No'}}</td>
