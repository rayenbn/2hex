            ...
            <div id="mc_embed_signup">
                ...
                <form action="https://2hex.us3.list-manage.com/subscribe/post?u=647f3b724d78e4fe975871794&amp;id=bb8f89e732" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll" style="max-width: 700px;">
                        ...
                        <h2 style="color: #d46671">DOWNLOAD THE SKATEBOARD COMPANY FOUNDERS BOOK</h2>
                        <p style="color: #d46671">BY 2HEX - YOUR GLOBAL SKATEBOARD SUPPLIER </p>

                        <p>Subscribe to our irregular emails about skateboard supplies for skateboard company founders
                            to <b>download the skateboard company founders book</b> right now!
                        Fill in the form and we will email the E-book to your provided email address. </p>
<p>
    <img alt="" src="/skateboard-deck-production/2hex-book-preview.jpg" style="width: 50%" />
                        ...
                        <br>
                                    ...
                                    <div class="clear"><input type="submit" value="Subscribe & Download the Book" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
                                </div>
                            </form>
                        </div>
