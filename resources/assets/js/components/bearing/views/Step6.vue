    ...
    export default {
		...
		data() {
			return {
                ...
                packfirsts: [
                    {name: 'Bulk  (Bearings in protective plastic tubes)', value: 1},
                    {name: 'Custom Cardboard Box', value: 2},
                    {name: 'Transparent Hardplastic Case', value: 3},
                    {name: 'Round Tin closed', value: 4},
                    {name: 'Round Tin with window', value: 5},
                    {name: 'Square Tin closed', value: 6},
                    {name: 'quare Tin with small window', value: 7},
                    {name: 'Square Tin with full window', value: 8}                ],
                brandfirsts: [
