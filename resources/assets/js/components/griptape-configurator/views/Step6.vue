        ...
        data() {
            return {
                ...
                colors: [
                    ...
                    {name: 'dark green'  , value : 'green',   image: '/img/griptape/colors/Color-Grips---Dark-Green.jpg'},
                    {name: 'green'       , value : '#32CD32', image: '/img/griptape/colors/Color-Grips---Green.jpg'},
